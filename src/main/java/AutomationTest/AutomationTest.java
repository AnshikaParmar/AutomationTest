	...
	public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < Math.min(webpageXPaths.length, 5); i++) {
            ...
            for (String resolution : resolutionsDesktop) {
                ...
                String filename = "Screenshotfirefox_" + dateTimeStr + "_" + i + "_" + resolution + "_Desktop.png";
                File destfile = new File("./Screenshotfirefox/" + filename);
            ...
            for (String resolution : resolutionsMobile) {
                ...
                Screenshot screenshot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(driver);
                BufferedImage image = screenshot.getImage();
                String filename = "Screenshotfirefox_" + dateTimeStr + "_" + i + "_" + resolution + "_Mobile.png";
                File destfile = new File("./Screenshotfirefox/" + filename);
                ImageIO.write(image, "PNG", destfile);
                System.out.println("Full-page screenshot saved: " + destfile.getAbsolutePath());
            }
